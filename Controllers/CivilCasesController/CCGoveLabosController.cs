...
{
    public class CCGoveLabosController : Controller
    {
        private readonly ApplicationDbContext _context;

        public CCGoveLabosController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var applicationDbContext = _context.CCFreelServices.Include(c => c.SectrorsDepartment).Where(c => c.CustomerCategory == CustomerCategory.የመንግስት);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken] // FreeLabrsCreate
        public async Task<IActionResult> FreeLabarsCreate(Guid SectrorsDepartmentId, CCFreelServices cCFreelServices)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                cCFreelServices.CustomerCategory = CustomerCategory.የመንግስት;

...
namespace ExpertManagmentSystem.Migrations
{
    ...
    [Migration("20240609012726_AddBirToContractInvestigation")]
    partial class AddBirToContractInvestigation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpertManagmentSystem.Models.CivilCaseModels.ContractInvestigation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AmountInBir")
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal?>("AmountPerMoney")
                    ...
                    b.Property<int?>("ContractInvestigationDocumentStatus")
                        .HasColumnType("int");

                    b.Property<int?>("ContractInvestigationDocumentType")
                        .HasColumnType("int");

                    b.Property<string>("ContractReciepient")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ProsecutorIdentityNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid?>("SectorDepartmentId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("TheInstitutionRequestedForExamination")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("SectorDepartmentId");

                    b.ToTable("ContractInvestigations", "ExpertUserMngt");
                });
            ...
            modelBuilder.Entity("ExpertManagmentSystem.Models.CivilCaseModels.DirectChargeOpenning", b =>
                {
                    ...
                    b.Property<string>("ProsecutorsRecordNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ExpertManagmentSystem.Models.CivilCaseModels.LeadingCommandAndAppealNotSupported", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("LeadingCommandAndUnSupportAppeal")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ProsecutorRecordNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProsecutorSupportTo")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("LeadingCommandUnAppealNotSupporteds", "ExpertUserMngt");
                });

            modelBuilder.Entity("ExpertManagmentSystem.Models.CivilCaseModels.PerformanceChargeFollowUp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("DiffrenetReasons")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool?>("HasBeenAppointed")
                        .HasColumnType("bit");

                    b.Property<bool?>("HasDecissionMade")
                        .HasColumnType("bit");

                    b.Property<decimal?>("MoneyGained")
                        .HasColumnType("decimal(18,2)");

                    b.Property<Guid?>("PerformanceChargeOpenningId")
                        .IsRequired()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("PerformanceChargeStatus")
                        .HasColumnType("int");

                    b.Property<string>("ProperyClosed")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid?>("SectorDepartmentId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("TypeOfDecission")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PerformanceChargeOpenningId");

                    b.HasIndex("SectorDepartmentId");

                    b.ToTable("PerformanceChargeFollowUps", "ExpertUserMngt");
                });

            modelBuilder.Entity("ExpertManagmentSystem.Models.CivilCaseModels.PerformanceChargeOpenning", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal?>("AmountInBirr")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("NameOfCourtCasePresented")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("TypeOfPerformanceCharge")
                        .HasColumnType("int");
                    ...
                    b.ToTable("PerformanceChargeOpennings", "ExpertUserMngt");
                });
            ...
            modelBuilder.Entity("ExpertManagmentSystem.Models.CivilCaseModels.ContractInvestigation", b =>
                {
                    ...
                    b.HasOne("ExpertManagmentSystem.OrganizationalStructures.SectrorsDepartment", "SectorDepartment")
                        .WithMany()
                        .HasForeignKey("SectorDepartmentId");

                    b.Navigation("ApplicationUser");

                    b.Navigation("SectorDepartment");
                });
            ...
            modelBuilder.Entity("ExpertManagmentSystem.Models.CivilCaseModels.PerformanceChargeFollowUp", b =>
                {
                    ...
                    b.HasOne("ExpertManagmentSystem.Models.CivilCaseModels.PerformanceChargeOpenning", "PerformanceChargeOpenning")
                        .WithMany("PerformanceChargeFollowUp")
                        .HasForeignKey("PerformanceChargeOpenningId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("PerformanceChargeOpenning");
            ...
            modelBuilder.Entity("ExpertManagmentSystem.Models.CivilCaseModels.PerformanceChargeOpenning", b =>
                {
                    b.Navigation("PerformanceChargeFollowUp");
                });
